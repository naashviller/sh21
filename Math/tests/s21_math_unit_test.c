...
Suite *abs_test() {
  Suite *s = suite_create("\033[92m-=S21_ABS=-\033[39m");
...
Suite *acos_test() {
  Suite *s = suite_create("\033[92m-=S21_ACOS=-\033[39m");
...
Suite *asin_test() {
  Suite *s = suite_create("\033[92m-=S21_ASIN=-\033[39m");
...
Suite *atan_test() {
  Suite *s = suite_create("\033[92m-=S21_ATAN=-\033[39m");
...
Suite *ceil_test() {
  Suite *s = suite_create("\033[92m-=S21_CEIL=-\033[39m");
...
Suite *cos_test() {
  Suite *s = suite_create("\033[92m-=S21_COS=-\033[39m");
...
Suite *exp_test() {
  Suite *s = suite_create("\033[92m-=S21_EXP=-\033[39m");
...
Suite *fabs_test() {
  Suite *s = suite_create("\033[92m-=S21_FABS=-\033[39m");
...
Suite *floor_test() {
  Suite *s = suite_create("\033[92m-=S21_FLOOR=-\033[39m");
...
Suite *fmod_test() {
  Suite *s = suite_create("\033[92m-=S21_FMOD=-\033[39m");
...
Suite *log_test() {
  Suite *s = suite_create("\033[92m-=S21_LOG=-\033[39m");
...
Suite *pow_test() {
  Suite *s = suite_create("\033[92m-=S21_POW=-\033[39m");
...
Suite *sin_test() {
  Suite *s = suite_create("\033[92m-=S21_SIN=-\033[39m");
...
Suite *sqrt_test() {
  Suite *s = suite_create("\033[92m-=S21_SQRT=-\033[39m");
...
Suite *tan_test() {
  Suite *s = suite_create("\033[92m-=S21_TAN=-\033[39m");
...
Suite *sin_cos_tan_test() {
  Suite *s = suite_create("\033[92m-=S21_SIN_COS_TAN=-\033[39m");
  TCase *tc = tcase_create("sin_cos_tan_tc");

  tcase_add_test(tc, sin_cos_tan_test_1);
  suite_add_tcase(s, tc);
...
//===========================================================
START_TEST(asin_acos_atan_test_1) {
...
Suite *asin_acos_atan_test() {
  Suite *s = suite_create("\033[92m-=S21_ASIN_ACOS_ATAN=-\033[39m");
  TCase *tc = tcase_create("asin_acos_atan_tc");

  tcase_add_test(tc, asin_acos_atan_test_1);
  suite_add_tcase(s, tc);
